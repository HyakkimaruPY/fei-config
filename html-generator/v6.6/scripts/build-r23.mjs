...
const standardCss=['runtime/standard/01.css','runtime/standard/02.css','runtime/standard/03-fixes.css','runtime/standard/12-ui-organization-lite.css','runtime/standard/13-tmdb-enrichment.css','runtime/standard/14-main-stream-style.css'];
...
const standardLitePatches=historicalInlinePatch+join(['runtime/standard/15-ui-organization-lite.js','runtime/standard/16-tmdb-enrichment.js','runtime/standard/17-main-stream-style.js']);
...
const manifest={revision,generatedAt:new Date().toISOString(),diagnosticBaseline:{standard:'46b9cd4-pre-aura'},standardLayer:'lite-ui-r13-detail-guides-history-delete',standard:{js:'standard.js',css:'standard.css'},shorts:{js:'shorts.js',css:'shorts.css'},themes:themeFiles.map(x=>path.basename(x,'.css'))};
