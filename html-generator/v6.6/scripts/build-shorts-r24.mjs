...
const manifest={revision,generatedAt:new Date().toISOString(),sourceCommit:OLD,architecture:'historical-modular-core',arcSeconds:120,css:'shorts.css',js:'shorts.js'};
