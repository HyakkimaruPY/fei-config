...
const manifest={revision,generatedAt:new Date().toISOString(),sourceCommit:OLD,architecture:'historical-modular-core+stable-feed-player',stableFeedPatch:'atomic-cover-v2',arcSeconds:120,css:'shorts.css',js:'shorts.js'};
