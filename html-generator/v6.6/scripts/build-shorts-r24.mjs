...
/* Performance rollback: keep the direct-first affinity bridge, but remove the
   later streamed-body stability reader and R26 detail-request override. The
   historical runtime goes back to native response.text() behavior. */
