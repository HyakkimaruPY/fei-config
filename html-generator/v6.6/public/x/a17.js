...
function ensureMiniStyles(){
  ...
  style.textContent='.srh25-mini-resume{position:fixed;z-index:94;left:12px;bottom:max(16px,env(safe-area-inset-bottom));width:calc(100vw - 24px);height:82px;display:grid;grid-template-columns:minmax(0,1fr);align-items:stretch;border:1px solid var(--line,rgba(255,255,255,.16));border-radius:18px;background:color-mix(in srgb,var(--bg-elev,#10161d) 92%,transparent);box-shadow:0 18px 50px rgba(0,0,0,.42);overflow:hidden;backdrop-filter:blur(18px);-webkit-backdrop-filter:blur(18px);transition:width .24s cubic-bezier(.22,1,.36,1),height .24s cubic-bezier(.22,1,.36,1),opacity .18s ease;touch-action:none}.srh25-mini-resume.is-hidden{display:none!important}.srh25-mini-resume.is-compact{width:min(190px,calc(100vw - 24px));height:68px}.srh25-mini-resume.is-dragging{transition:none!important}.srh25-mini-open{min-width:0;width:100%;height:100%;display:grid;grid-template-columns:66px minmax(0,1fr);align-items:center;gap:10px;padding:7px 44px 7px 7px;background:transparent;color:inherit;text-align:left}.srh25-mini-resume.is-compact .srh25-mini-open{grid-template-columns:54px minmax(0,1fr);gap:8px;padding:6px}.srh25-mini-thumb{position:relative;width:66px;height:68px;border-radius:12px;overflow:hidden;background:var(--surface,#111820)}.srh25-mini-resume.is-compact .srh25-mini-thumb{width:54px;height:56px}.srh25-mini-thumb img{width:100%;height:100%;display:block;object-fit:cover;background:var(--surface,#111820)}.srh25-mini-play{position:absolute;left:50%;top:50%;width:28px;height:28px;transform:translate(-50%,-50%);display:grid;place-items:center;border:1px solid rgba(255,255,255,.28);border-radius:50%;background:rgba(0,0,0,.52)}.srh25-mini-play svg{width:13px;height:13px;fill:none;stroke:#fff;stroke-width:2;stroke-linejoin:round}.srh25-mini-copy{min-width:0;display:block}.srh25-mini-title{display:block;overflow:hidden;text-overflow:ellipsis;white-space:nowrap;font-size:12px;font-weight:800}.srh25-mini-resume.is-compact .srh25-mini-title{font-size:10px}.srh25-mini-episode{display:block;margin-top:4px;color:var(--muted,#929aa5);font-size:10px;font-weight:760}.srh25-mini-progress{display:block;height:3px;margin-top:8px;border-radius:999px;overflow:hidden;background:rgba(255,255,255,.12)}.srh25-mini-progress i{display:block;width:0;height:100%;border-radius:inherit;background:var(--accent,#d8dee7)}.srh25-mini-close{position:absolute;z-index:4;top:7px;right:7px;width:30px;height:30px;display:grid;place-items:center;border:1px solid rgba(255,255,255,.14);border-radius:50%;background:rgba(0,0,0,.34);color:var(--muted,#c7cdd6)}.srh25-mini-close svg{width:16px;height:16px;fill:none;stroke:currentColor;stroke-width:1.8;stroke-linecap:round}.srh25-mini-resume.is-compact .srh25-mini-close{display:none}.srh25-mini-resume.is-compact .srh25-mini-open{padding-right:6px}.srh25-mini-resume.is-compact .srh25-mini-progress{margin-top:6px}.srh25-mini-resume.is-compact .srh25-mini-play{width:24px;height:24px}@media(min-width:800px){.srh25-mini-resume{left:18px;bottom:18px}}';
