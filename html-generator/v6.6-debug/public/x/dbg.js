...
function observeVideos(){
  ...
  const trace=m=>{let x=traces.get(m);if(!x){x={loadAt:0,metadataMs:0,firstPlaying:false,waitingAt:0,startupBufferMs:0,stallTimer:0,origin:'',retrying:false};traces.set(m,x)}return x};
