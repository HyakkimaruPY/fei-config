...
const BATCH=12,LIBRARY_BATCH=6,CACHE_MAX_AGE=6*60*60*1000;let shown=0,observer=null,imgObserver=null,activeLibrary=null,updateCandidate=null,updateCategories=[],updateSelected=new Set(),libraryRenderToken=0,scrollPerfTimer=0,renderDeferTimer=0,renderPendingItems=null,appendDeferTimer=0,imageFlushTimer=0,scrollPerfActive=false;const pendingImageLoads=new Set();
