...
function installFeedWakeups(){
  ...
  document.addEventListener('pointerdown',e=>{if(e.target?.closest?.('.srh25-card,#settingsButton,#historyButton,#favoritesButton'))setTimeout(()=>scheduleFeedPump(90),980)},{passive:true,capture:true});
